...
namespace FEG.Reportes
{
    public class ReporteCliente
    {
        ...
        public byte[] Reporte(List<Clientes> lista)
        {
            ...
            anchoColumnas[0] = 130; //Esta sera la fila 1 clienteId
            anchoColumnas[1] = 130; //Esta sera la fila 11 usuarioId
            ...
            anchoColumnas[7] = 175; //Esta sera la fila 7 direccion
            anchoColumnas[8] = 180; //Esta sera la fila 8 Fecha
